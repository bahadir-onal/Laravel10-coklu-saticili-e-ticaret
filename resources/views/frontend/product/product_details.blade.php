...
@section('title')
    {{ $product->product_name }} | Bahadır Önal
@endsection
                        ...
                        <div class="row mb-50 mt-30">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    @endif
                                    <h2 class="title-detail" id="dproductName">{{ $product->product_name }}</h2>
                            ...
                            <div class="tab-style3">
                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    ...
                                    <div class="tab-pane fade" id="Vendor-info">
                                        <img src="{{ (!empty($product->vendor->photo)) ? url('upload/vendor_images/'.$product->vendor->photo) : url('upload/no-image.jpg/') }}" alt="">
                                                            ...
                                                            <div class="single-comment justify-content-between d-flex mb-30">
                                                                <div class="user justify-content-between d-flex">
                                                                    <div class="thumb text-center">
                                                                        <img src="{{ (!empty($item->user->photo)) ? url('upload/user_images/'.$item->user->photo) : url('upload/no-image.jpg/') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110" alt="" />
