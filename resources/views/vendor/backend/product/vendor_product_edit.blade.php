...
<div class="page-content">
              ...
              <div class="card">
				  <div class="card-body p-4">
					  ...
					  <hr/>
                      <form id="myForm" method="post" action="{{ route('vendor.product.update') }}">
                        @csrf
					    ...
					    <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
							...
							<div class="form-group mb-3">
								...
								<textarea class="form-control" name="short_description" id="inputProductDescription" rows="3">{{ $products->short_description }}</textarea>
							</div>
            ...
            <!--MAIN IMAGE THUMBNAİL UPDATE-->
            <div class="page-content">
                <h6 class="mb-0 text-uppercase">UPDATE MAIN IMAGE THUMBNAIL</h6>
                <hr>
                <div class="card">
                    <form method="post" action="{{ route('vendor.product.update.thumbnail') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $products->id }}">
                            ...
                            @csrf
                                @foreach($multiImages as $key => $image)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset($image->photo_name) }}" style="width: 70px; height: 40px;"></td>
                                        <td><input name="multi_images[{{ $image->id }}]" class="form-group" type="file"></td>
                                        <td>
