                            ...
                            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    @elseif($order->status == 'confirm')
                                        <th><a href="{{ route('confirm-processing',$order->id) }}" class="btn btn-block btn-success" id="processing">Processing Order</a></th>
                                    @elseif($order->status == 'processing')
                                        <th><a href="{{ route('processing-delivered',$order->id) }}" class="btn btn-block btn-success" id="delivered">Delivered Order</a></th>
                                    @endif
                                </tr>
                                </table>
                            </div>
