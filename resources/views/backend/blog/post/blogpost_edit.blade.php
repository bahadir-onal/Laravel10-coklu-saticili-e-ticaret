									...
									<div class="card-body">
                                        <form id="myForm" method="post" action="{{ route('update.blog.post') }}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group col-sm-9 text-secondary">
                                                    <select name="category_id" class="form-select" id="inputVendor">
                                                        ...
                                                        @foreach($blogCategories as $cat)
                                                            <option value="{{ $cat->id }}" {{ $cat->id == $blogPost->category_id ? 'selected' : '' }}>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-sm-9 text-secondary">
                                                    <textarea name="post_short_description" class="form-control" rows="4">{{ $blogPost->post_short_description }}</textarea>
                                                </div>
                                            </div>
