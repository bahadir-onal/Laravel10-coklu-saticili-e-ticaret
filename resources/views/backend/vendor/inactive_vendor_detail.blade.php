									...
									<div class="card-body">
                                        <form method="post" action="{{ route('active.vendor.approve') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <textarea class="form-control" name="vendor_short_info" id="inputAddress2" placeholder="Vendor Info" rows="3">{{ $inActiveVendorDetails->vendor_short_info }}</textarea>                                                
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <img id="showImage" src="{{ (!empty($inActiveVendorDetails->photo)) ? url('upload/vendor_images/'.$inActiveVendorDetails->photo) : url('upload/no-image.jpg/') }}" alt="Admin" style="width: 100px; height: 100px;"  width="110">
                                                </div>
                                            </div>
